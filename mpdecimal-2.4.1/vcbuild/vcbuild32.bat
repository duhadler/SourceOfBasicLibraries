...
copy /y libmpdec-2.4.1.lib ..\vcbuild\dist32
...
copy /y libmpdec-2.4.1.dll ..\vcbuild\dist32
copy /y libmpdec-2.4.1.dll.lib ..\vcbuild\dist32
copy /y libmpdec-2.4.1.dll.exp ..\vcbuild\dist32
